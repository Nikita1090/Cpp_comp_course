...
int main()
{
    ...
    // всё что выше эт прошлое дз ^^^^^^^
    Queue Q(3);
    cout << "queue created" << endl;
    cout << "Empty? " << (Q.empty() == 1? "Yes" : "No") << endl;
    Q.back(zakaz1);
    cout << "queue pushed" << endl;
    Q.back(zakaz2);
    cout << "queue pushed" << endl;
    cout << "Empty? " << (Q.empty() == 1? "Yes" : "No") << endl;
    cout << "Full? " << (Q.full() == 1? "Yes" : "No") << endl;
    Q.back(zakaz3);
    cout << "queue pushed" << endl;
    cout << "Full? " << (Q.full() == 1? "Yes" : "No") << endl;
    Q.back(zakaz3);
    cout << "queue pushed" << endl;
    Q.print();
    ElemOfData* what_we_get = Q.front();
    cout << "Element we got:" << endl;
    what_we_get->print_all();
    delete what_we_get;
    what_we_get = Q.pop();
    delete what_we_get;
    what_we_get = Q.pop();
